...
class VideoDownloader:
    ...
    def _normalize_url(self, url: str) -> str:
        ...
        # Для TikTok убираем всё лишнее после знака вопроса
    ...
    def _get_opts(self, url, filename_tmpl):
        ...
        opts = {
            ...
            'user_agent': ua,
            # Принудительно IPv4, так как IPv6 хостингов часто в бане
        ...
        if "instagram.com" in url:
            ...
            # TikTok ОЧЕНЬ чувствителен к заголовкам
    ...
    def _process_video(self, input_path, duration):
        ...
        # Рекодинг в yuv420p обязателен для совместимости с Telegram/iPhone
